    ...
    function rejectList() {
        ...
        $http.post(SiteUrl + '/leaves', { employeeid: userid, status: 'rejected' }).success(function (result) {
            if (result.status == "Success") {
                ...
                //AprroverId = result.leaves.approverid;
        ...
        $scope.ReApply = function (Id, approverId) {
             debugger;
             UserLeaveId = Id;
       ...
       debugger;
        if ($scope.data.selectedleavetype == null
            ...
            $http.post(SiteUrl + '/leave', {
                ...
                approverid: $scope.data.selectedPerson,
                attachment: [],
                ...
                if (result.status == "Success") {
                    ...
                    //    message: 'The leave applied by ' + fullname + ' From ' + $scope.data.FromDate + ' ' + $scope.data.ToDate,
                    //    GCMRegToken: device_token
                    //}).success(function (result) {
                    //    if (result.status == "Success") {
                    //        debugger;
                    //        console.log(result);
...
.controller('rejectCtrl', function ($scope, $ionicPopup, $state, $http) {
    $scope.data = {};
...
.controller('forwardCtrl', function ($scope, $ionicPopup, $state, $http) {
    // debugger;
    $scope.loading = $ionicLoading.show({
        content: '<i class="icon ion-loading-c"></i>',
        animation: 'fade-in',
